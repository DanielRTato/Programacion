public class  AsalariadoA extends TrabajadorA {
    ...
    public AsalariadoA(String cargo, double soldo, double ss, double irpf, String nome, String dni, String dataIngreso){
